...
def step_impl(context):
  ...
  axes.plot(context.x, context.y)
  toyplot.testing.assert_canvas_equal(canvas, "explicit-tick-locator-locations")
...
def step_impl(context):
  ...
  axes.plot(context.x, context.y)
  toyplot.testing.assert_canvas_equal(canvas, "explicit-tick-locator-locations-labels")
