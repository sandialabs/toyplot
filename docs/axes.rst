...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        if(!window.CSS.supports("alignment-baseline", "middle"))
        {
          ...
          var text = document.querySelectorAll("#tbdd013e1d5cc46daa3661bb1c5260f06 text");
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#tbdd013e1d5cc46daa3661bb1c5260f06 .toyplot-mark-popup");
      ...
      var datasets = document.querySelectorAll("#tbdd013e1d5cc46daa3661bb1c5260f06 toyplot\\:data-table");
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#tbdd013e1d5cc46daa3661bb1c5260f06 .toyplot-axes-Cartesian .toyplot-coordinate-events");
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t66f2844901e94b44b45696c0bcd2fdfd text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#t66f2844901e94b44b45696c0bcd2fdfd .toyplot-mark-popup");
          popup.querySelector(".toyplot-mark-popup-title").innerHTML = dataset.getAttribute("title");
          popup.querySelector(".toyplot-mark-popup-save-csv").onclick = function() { popup.style.visibility = "hidden"; save_csv(dataset); }
          popup.style.left = (e.clientX - 50) + "px";
          popup.style.top = (e.clientY - 20) + "px";
      ...
      var datasets = document.querySelectorAll("#t66f2844901e94b44b45696c0bcd2fdfd toyplot\\:data-table");
      for(var i = 0; i != datasets.length; ++i)
      {
        var dataset = datasets[i];
        var mark = dataset.parentElement;
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t66f2844901e94b44b45696c0bcd2fdfd .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t76aa99dbb31c45f59acf0b48640c38a5 text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t76aa99dbb31c45f59acf0b48640c38a5 .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t380d4a292c0444a081a113650dd82957 text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#t380d4a292c0444a081a113650dd82957 .toyplot-mark-popup");
          popup.querySelector(".toyplot-mark-popup-title").innerHTML = dataset.getAttribute("title");
          popup.querySelector(".toyplot-mark-popup-save-csv").onclick = function() { popup.style.visibility = "hidden"; save_csv(dataset); }
          popup.style.left = (e.clientX - 50) + "px";
          popup.style.top = (e.clientY - 20) + "px";
      ...
      var datasets = document.querySelectorAll("#t380d4a292c0444a081a113650dd82957 toyplot\\:data-table");
      for(var i = 0; i != datasets.length; ++i)
      {
        var dataset = datasets[i];
        var mark = dataset.parentElement;
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t380d4a292c0444a081a113650dd82957 .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t0b65184e3dfa4f548500b474a32d0751 text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#t0b65184e3dfa4f548500b474a32d0751 .toyplot-mark-popup");
          popup.querySelector(".toyplot-mark-popup-title").innerHTML = dataset.getAttribute("title");
          popup.querySelector(".toyplot-mark-popup-save-csv").onclick = function() { popup.style.visibility = "hidden"; save_csv(dataset); }
          popup.style.left = (e.clientX - 50) + "px";
          popup.style.top = (e.clientY - 20) + "px";
      ...
      var datasets = document.querySelectorAll("#t0b65184e3dfa4f548500b474a32d0751 toyplot\\:data-table");
      for(var i = 0; i != datasets.length; ++i)
      {
        var dataset = datasets[i];
        var mark = dataset.parentElement;
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t0b65184e3dfa4f548500b474a32d0751 .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t986c2f814ffc4ff393904b131a1298b2 text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#t986c2f814ffc4ff393904b131a1298b2 .toyplot-mark-popup");
          popup.querySelector(".toyplot-mark-popup-title").innerHTML = dataset.getAttribute("title");
          popup.querySelector(".toyplot-mark-popup-save-csv").onclick = function() { popup.style.visibility = "hidden"; save_csv(dataset); }
          popup.style.left = (e.clientX - 50) + "px";
          popup.style.top = (e.clientY - 20) + "px";
      ...
      var datasets = document.querySelectorAll("#t986c2f814ffc4ff393904b131a1298b2 toyplot\\:data-table");
      for(var i = 0; i != datasets.length; ++i)
      {
        var dataset = datasets[i];
        var mark = dataset.parentElement;
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t986c2f814ffc4ff393904b131a1298b2 .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        ...
        {
          var re = /\s*alignment-baseline\s*:\s*([^;\s]*)\s*/;
          var text = document.querySelectorAll("#t16a38a5d60e744c6910d68a1a28129d6 text");
          for(var i = 0; i != text.length; ++i)
          {
            var match = re.exec(text[i].attributes.style.value);
            if(match)
    ...
    (function()
    {
      ...
      function open_popup(dataset)
      {
        return function(e)
        {
          var popup = document.querySelector("#t16a38a5d60e744c6910d68a1a28129d6 .toyplot-mark-popup");
          popup.querySelector(".toyplot-mark-popup-title").innerHTML = dataset.getAttribute("title");
          popup.querySelector(".toyplot-mark-popup-save-csv").onclick = function() { popup.style.visibility = "hidden"; save_csv(dataset); }
          popup.style.left = (e.clientX - 50) + "px";
          popup.style.top = (e.clientY - 20) + "px";
      ...
      var datasets = document.querySelectorAll("#t16a38a5d60e744c6910d68a1a28129d6 toyplot\\:data-table");
      for(var i = 0; i != datasets.length; ++i)
      {
        var dataset = datasets[i];
        var mark = dataset.parentElement;
    ...
    (function()
    {
      ...
      var axes = document.querySelectorAll("#t16a38a5d60e744c6910d68a1a28129d6 .toyplot-axes-Cartesian .toyplot-coordinate-events");
      for(var i = 0; i != axes.length; ++i)
      {
        axes[i].onmousemove = display_coordinates;
        axes[i].onmouseout = clear_coordinates;
