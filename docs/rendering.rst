...
.. raw:: html
    ...
    (function()
    {
      if(window.CSS !== undefined && window.CSS.supports !== undefined)
      {
        if(!window.CSS.supports("alignment-baseline", "middle"))
        {
          ...
          var text = document.querySelectorAll("#t7d83451ecf7f49c1abec80aced88a07d text");
    ...
    (function()
    {
      ...
      function open_popup(data_table)
      {
        return function(e)
        {
          var popup = document.querySelector("#t7d83451ecf7f49c1abec80aced88a07d .toyplot-mark-popup");
    ...
    (function()
    {
      var axes = {"t1fcd6a537b484dfcaa8c75ed83912a27": {"x": [{"domain": {"bounds": {"max": Infinity, "min": -Infinity}, "max": 1.0, "min": 0.0}, "range": {"bounds": {"max": Infinity, "min": -Infinity}, "max": 240.0, "min": 60.0}, "scale": "linear"}], "y": [{"domain": {"bounds": {"max": Infinity, "min": -Infinity}, "max": 1.0, "min": 0.0}, "range": {"bounds": {"max": -Infinity, "min": Infinity}, "max": 60.0, "min": 240.0}, "scale": "linear"}]}};
...
your canvas, using one of Toyplot's rendering ``backends``. For example,
you could use the :mod:`toyplot.browser` backend to display the canvas
