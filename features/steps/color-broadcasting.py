...
def step_impl(context):
    context.axes.bars(context.series, baseline="symmetric", color=(context.series_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.bars(context.series, baseline="symmetric", color=(context.datum_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.fill(context.series, baseline="symmetric", color=(context.series_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    datum_values = numpy.arange(len(context.series[:,0]))
    context.axes.hlines(context.series[:,0], color=(datum_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.plot(context.series, color=(context.series_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.plot(context.series, marker="o", mfill=(context.series_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.plot(context.series, marker="o", mfill=(context.datum_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.rects(context.series[:-1,0], context.series[1:,0], context.series[:-1,1], context.series[1:,1], color=(context.datum_values[:-1,0], toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.scatterplot(context.series, color=(context.series_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    context.axes.scatterplot(context.series, color=(context.datum_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    text = ["#"] * len(context.series)
    datum_values = numpy.arange(len(context.series[:,0]))
    context.axes.text(context.x, context.series[:,0], text, annotation=False, color=(datum_values, toyplot.color.brewer("BlueRed")))
...
def step_impl(context):
    datum_values = numpy.arange(len(context.series[:,0]))
    context.axes.vlines(context.series[:,0], color=(datum_values, toyplot.color.brewer("BlueRed")))
