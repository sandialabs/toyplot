...
def step_impl(context):
    ...
    toyplot.testing.assert_canvas_equal(
        context.canvas, "unicode-cartesian-x-label")
...
def step_impl(context):
    ...
    toyplot.testing.assert_canvas_equal(
        context.canvas, "unicode-cartesian-y-label")
...
def step_impl(context):
    ...
    toyplot.testing.assert_canvas_equal(
        context.canvas, "unicode-cartesian-label")
...
def step_impl(context):
    ...
    toyplot.testing.assert_canvas_equal(
        context.canvas, "unicode-cartesian-tick-labels")
...
def step_impl(context):
    ...
    axes.text(0, 0, u"L\u0302")
    toyplot.testing.assert_canvas_equal(
        context.canvas, "unicode-cartesian-text")
