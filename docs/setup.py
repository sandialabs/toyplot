...
for name in ["canvas-layout", "cartesian-axes", "color", "convenience", "data-tables", "labels-and-legends", "markers", "matrix-visualization", "rendering", "table-axes", "text", "tutorial", "units"]:
